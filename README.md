...
- **Vincular eBooks con productos**. Vincula todos los productos aún no vinculados a un eBook, si desea que algún libro en específico no tenga eBook, actualice el attributo `eBook` a `No`. Para acceder a esta opción puede hacerlo desde el menú `Alfaomega eBooks > Vincular Productos` o desde la página principal del complemento.
  > **Importante!**
